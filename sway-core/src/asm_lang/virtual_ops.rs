...
impl VirtualOp {
    ...
    pub(crate) fn update_register(
        ...
        match self {
            ...
            NOT(r1, r2) => Self::NOT(update_reg(full_map, r1), update_reg(full_map, r2)),
            OR(r1, r2, r3) => Self::OR(
                update_reg(full_map, r1),
                update_reg(full_map, r2),
                update_reg(full_map, r3),
            ...
            CTMV(r1, r2) => Self::CTMV(update_reg(full_map, r1), update_reg(full_map, r2)),
            ...
            RETD(r1, r2) => Self::RETD(update_reg(full_map, r1), update_reg(full_map, r2)),
            ...
            ALOC(r1) => Self::ALOC(update_reg(full_map, r1)),
            MCL(r1, r2) => Self::MCL(update_reg(full_map, r1), update_reg(full_map, r2)),
            MCLI(r1, i) => Self::MCLI(update_reg(full_map, r1), i.clone()),
            ...
            BHSH(r1, r2) => Self::BHSH(update_reg(full_map, r1), update_reg(full_map, r2)),
            BHEI(r1) => Self::BHEI(update_reg(full_map, r1)),
            BURN(r1) => Self::BURN(update_reg(full_map, r1)),
            ...
            CROO(r1, r2) => Self::CROO(update_reg(full_map, r1), update_reg(full_map, r2)),
            CSIZ(r1, r2) => Self::CSIZ(update_reg(full_map, r1), update_reg(full_map, r2)),
            CB(r1) => Self::CB(update_reg(full_map, r1)),
            ...
            MINT(r1) => Self::MINT(update_reg(full_map, r1)),
            ...
            SRW(r1, r2) => Self::SRW(update_reg(full_map, r1), update_reg(full_map, r2)),
            SRWQ(r1, r2) => Self::SRWQ(update_reg(full_map, r1), update_reg(full_map, r2)),
            SWW(r1, r2) => Self::SWW(update_reg(full_map, r1), update_reg(full_map, r2)),
            SWWQ(r1, r2) => Self::SWWQ(update_reg(full_map, r1), update_reg(full_map, r2)),
            TR(r1, r2, r3) => Self::TR(
                update_reg(full_map, r1),
                update_reg(full_map, r2),
                update_reg(full_map, r3),
            ...
            XOS(r1, r2) => Self::XOS(update_reg(full_map, r1), update_reg(full_map, r2)),
            NOOP => Self::NOOP,
            FLAG(r1) => Self::FLAG(update_reg(full_map, r1)),
            GM(r1, i) => Self::GM(update_reg(full_map, r1), i.clone()),
